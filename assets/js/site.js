...
const strings = {
  en: {
    nav_app: "The app",
    app_eyebrow: "A look inside",
    app_title: "This is the actual app.",
    app_desc: "Not mockups. These are real screens from HARI, running on a phone in Colombo.",
    app1_label: "Home",
    app1_title: "One screen, whole job",
    app1_body: "Your saved address up top, a search bar, and — when a job is running — a card showing your pro is on the way. One tap goes straight to the map.",
    app2_label: "Choosing",
    app2_title: "Real detail, not just names",
    app2_body: "Five pros nearby, each with a verified badge, a rating, the number of jobs they have finished, how far away they are and an ETA. You pick; nobody is assigned to you.",
    app3_label: "The price",
    app3_title: "Checked before you see it",
    app3_body: "The plumber quoted LKR 12,500. HARI reviewed it against the site-visit report and approved LKR 11,800 — so the number you see has already been argued down on your behalf.",
    app4_label: "On the way",
    app4_title: "Watch them come to you",
    app4_body: "A real Colombo map, five clear stages, and 5 min · 2.0 km to your door. The SOS button sits within thumb reach the whole time.",
    app5_label: "Your language",
    app5_title: "English, සිංහල, தமிழ்",
    app5_body: "The entire app switches language, not just the menus. The same three languages as this page.",
    ...
    hero_survey_note: "Takes 30 seconds, and it helps us get ready for what people actually need.",
  ...
  si: {
    nav_app: "ඇප් එක",
    app_eyebrow: "ඇතුළේ මොකද්ද",
    app_title: "මේ තමයි ඇත්ත ඇප් එක.",
    app_desc: "මොක් අප් නෙවෙයි. මේ කොළඹ ෆෝන් එකක දුවන ඇත්තම HARI තිර.",
    app1_label: "මුල් පිටුව",
    app1_title: "එක තිරයක, මුළු වැඩේ",
    app1_body: "උඩින් ඔබේ ලිපිනය, සර්ච් බාර් එකක්, වැඩක් යනකොට කාර්මිකයා එනවා කියලා පෙන්නන කාඩ් එකක්. එක තැපිල්ලෙන් කෙලින්ම සිතියමට.",
    app2_label: "තෝරාගැනීම",
    app2_title: "නම විතරක් නෙවෙයි",
    app2_body: "අවට කාර්මිකයෝ පහක්. හැම කෙනෙකුටම වෙරිෆයිඩ් බැජ් එකක්, ශ්‍රේණියක්, කරපු වැඩ ගාන, දුර සහ කීයටද එන්නේ කියලා. තෝරන්නේ ඔබයි — කවුරුවත් ඔබට පටවන්නේ නෑ.",
    app3_label: "ගාන",
    app3_title: "ඔබ දකින්න කලින් චෙක් කරනවා",
    app3_body: "ජලනල කාර්මිකයා කිව්වේ රු. 12,500. HARI ඒක සයිට් විසිට් රිපෝට් එකට බලලා රු. 11,800ට අනුමත කළා — ඒ කියන්නේ ඔබ දකින ගාන දැනටමත් ඔබ වෙනුවෙන් අඩු කරලා තියෙනවා.",
    app4_label: "එන ගමන්",
    app4_title: "එනකම් බලාගෙන ඉන්න",
    app4_body: "ඇත්තම කොළඹ සිතියම, පැහැදිලි පියවර පහක්, ගෙදරට විනාඩි 5 · කි.මී. 2.0. SOS බොත්තම හැම වෙලේම ඇඟිල්ලට ළඟයි.",
    app5_label: "ඔබේ භාෂාව",
    app5_title: "English, සිංහල, தமிழ்",
    app5_body: "මෙනු විතරක් නෙවෙයි, මුළු ඇප් එකම භාෂාව මාරු වෙනවා. මේ පිටුවේම භාෂා තුනම.",
    ...
    hero_survey_note: "තත්පර 30යි. මිනිස්සුන්ට ඇත්තටම ඕන මොනවද කියලා දැනගන්න මේක අපිට උදව් වෙනවා.",
  ...
  ta: {
    nav_app: "செயலி",
    app_eyebrow: "உள்ளே ஒரு பார்வை",
    app_title: "இதுவே உண்மையான செயலி.",
    app_desc: "மாதிரிகள் அல்ல. இவை கொழும்பில் ஒரு தொலைபேசியில் இயங்கும் HARI-யின் உண்மையான திரைகள்.",
    app1_label: "முதற் பக்கம்",
    app1_title: "ஒரு திரை, முழு வேலை",
    app1_body: "மேலே உங்கள் முகவரி, ஒரு தேடல் பட்டி, வேலை நடக்கும்போது தொழில்முறையாளர் வந்துகொண்டிருப்பதைக் காட்டும் அட்டை. ஒரு தட்டலில் நேரடியாக வரைபடத்திற்கு.",
    app2_label: "தேர்வு",
    app2_title: "பெயர் மட்டுமல்ல",
    app2_body: "அருகில் ஐந்து தொழில்முறையாளர்கள். ஒவ்வொருவருக்கும் சரிபார்ப்புச் சின்னம், மதிப்பீடு, முடித்த வேலைகளின் எண்ணிக்கை, தூரம் மற்றும் வரும் நேரம். நீங்களே தேர்வு செய்கிறீர்கள்.",
    app3_label: "விலை",
    app3_title: "நீங்கள் பார்ப்பதற்கு முன் சரிபார்க்கப்படுகிறது",
    app3_body: "குழாய் வேலைக்காரர் ரூ. 12,500 கேட்டார். HARI அதை தள வருகை அறிக்கையுடன் ஒப்பிட்டு ரூ. 11,800 ஆக அனுமதித்தது — நீங்கள் பார்க்கும் தொகை உங்களுக்காக ஏற்கனவே குறைக்கப்பட்டது.",
    app4_label: "வரும் வழியில்",
    app4_title: "வருவதைப் பாருங்கள்",
    app4_body: "உண்மையான கொழும்பு வரைபடம், தெளிவான ஐந்து நிலைகள், உங்கள் வாசலுக்கு 5 நிமிடம் · 2.0 கி.மீ. SOS பொத்தான் எப்போதும் கை எட்டும் தூரத்தில்.",
    app5_label: "உங்கள் மொழி",
    app5_title: "English, සිංහල, தமிழ்",
    app5_body: "பட்டியல்கள் மட்டுமல்ல, முழு செயலியும் மொழியை மாற்றுகிறது. இந்தப் பக்கத்தின் அதே மூன்று மொழிகள்.",
    ...
    hero_survey_note: "30 வினாடிகள். மக்களுக்கு உண்மையில் என்ன தேவை என்பதை அறிய இது எங்களுக்கு உதவுகிறது.",
